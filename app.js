...
app.get("/catalog", async (req, res) => {
    try {
        res.json({ status: responseStatus.success, catalog: catalog, message: "Catalogo obtenido correctamente" });
        logger.log("log", "app", "getCatalog", "Catalogo despachado correctamente");
    } catch (error) {
        res.json({ status: responseStatus.error, message: "Error al obtener el catalogo" });
