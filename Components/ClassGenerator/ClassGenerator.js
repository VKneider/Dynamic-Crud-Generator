      ...
      fs.writeFile(`${tableName}.js`, classContent, (err) => {
        if (err) {
          ...
          logger.log(
            ...
            'ClassGenerator',
            'generateClassFiles',
            `❌ Error al crear el archivo ${tableName}.js: ${err}`,
          );
        }
        ...
        logger.log(
          ...
          'ClassGenerator',
          'generateClassFiles',
          `✅ Archivo ${tableName}.js creado exitosamente.`,
        );
      });
    });
  }
  ...
  async getCatalog() {
    try {
      ...
      logger.log(
        ...
        'ClassGenerator',
        'getCatalog',
        `Error al obtener el catálogo de tablas y campos: ${error}`,
      );
    }
  }
...
const classGenerator = new ClassGenerator(db);
